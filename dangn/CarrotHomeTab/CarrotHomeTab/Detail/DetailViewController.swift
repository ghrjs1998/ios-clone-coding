...
class DetailViewController: UIViewController {
    ...
    private func configureNavigationBar() {
        let morehConfig = CustomBarItemConfiguration(image: UIImage(systemName: "ellipsis"), handler: {print("--> more tapped")})
        
        let moreItem = UIBarButtonItem.generate(with: morehConfig, width: 30)
